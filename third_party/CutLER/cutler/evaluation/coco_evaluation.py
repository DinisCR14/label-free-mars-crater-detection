...
def _evaluate_predictions_on_coco(
    ...
    # 🟢 CUSTOM AREA RANGES FOR CRATERS 🟢
    if iou_type in {"bbox", "segm"}:
        coco_eval.params.areaRng = [
            [0, 1e10],         # All craters default=[0, 1e10]
            [0, circle_area(r=5)],      # Small craters default=[0, 32**2]
            [circle_area(r=5), circle_area(r=20)], # Medium craters default=[32**2, 96**2]
            [circle_area(r=20), 1e10]   # Large craters default=[96**2, 1e10]
        ]
